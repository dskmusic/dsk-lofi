...
(function () {
  ...
  const HELP = {
    ...
    en:
      ...
      '<p>In the mini-list header, the <b>repeat</b> button cycles through <b>off</b>, <b>repeat current</b> (a "1") and <b>repeat all</b>. <b>Press and hold</b> the ◀/▶ buttons to rewind or fast-forward within the track (&lt;&lt;/&gt;&gt;, with acceleration); a short tap changes track. And <b>holding Play/Pause</b> opens <b>A–B repeat</b>: mark <b>A</b> and <b>B</b> (SET buttons), fine-tune them with −/+, and the app loops that section. When a <b>waveform</b> is available (full mode, not player-only) you see the zoomed region and can <b>drag A or B with your finger</b> on it; setting/moving a point zooms the view to that area with margin. <b>CLEAR</b> turns it off (it also clears when the track changes).</p>' +
