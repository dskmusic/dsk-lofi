  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        m_download: "Download",
        ab_title: "A–B REPEAT", ab_set: "SET", ab_clear: "CLEAR", ab_hint: "Set A and B to loop that section. Use −/+ to fine-tune.", ab_wave_na: "Waveform available in full mode (not player-only)",
    ...
    es: {
      ...
      strings: {
        ...
        ab_title: "REPETIR A–B", ab_set: "FIJAR", ab_clear: "LIMPIAR", ab_hint: "Marca A y B para repetir ese tramo. Usa −/+ para ajustar.", ab_wave_na: "Forma de onda disponible en modo completo (no en modo reproductor)",
