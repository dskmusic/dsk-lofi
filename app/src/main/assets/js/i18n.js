  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        stm_title: "AI VOICE SEPARATION", stm_model: "MODEL", stm_model_default: "Default (auto-download)", stm_tier_fast: "Fastest", stm_tier_mid: "Medium", stm_tier_yours: "Yours / others", stm_installed: "Downloaded", stm_tier_fav: "Favorites", stm_fav: "Favorite", stm_delete: "Delete", stm_deleted: "Model deleted", stm_del_confirm: "Delete this model file?", stm_download: "Download", stm_dl_done: "Model downloaded", stm_dl_fail: "Download failed", stm_dl_busy: "A download is already running", stm_pick_model: "Download and pick a model first",
