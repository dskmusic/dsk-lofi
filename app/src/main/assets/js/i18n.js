  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        m_download: "Download",
        ab_title: "A–B REPEAT", ab_set: "SET", ab_clear: "CLEAR", ab_hint: "Set A and B to loop that section. Use −/+ to fine-tune.",
    ...
    es: {
      ...
      strings: {
        ...
        ab_title: "REPETIR A–B", ab_set: "FIJAR", ab_clear: "LIMPIAR", ab_hint: "Marca A y B para repetir ese tramo. Usa −/+ para ajustar.",
