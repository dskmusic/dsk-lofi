  ...
  const LANGS = {
    ...
    es: {
      ...
      strings: {
        ...
        stm_title: "SEPARACIÓN DE VOZ (IA)", stm_model: "MODELO", stm_model_default: "Por defecto (se descarga)", stm_tier_fast: "Más rápidos", stm_tier_mid: "Medios", stm_tier_yours: "Tuyos / otros", stm_installed: "Descargado", stm_download: "Descargar", stm_dl_done: "Modelo descargado", stm_dl_fail: "Fallo al descargar", stm_dl_busy: "Ya hay una descarga en curso", stm_pick_model: "Descarga y elige un modelo primero",
        ...
        stm_done: "Separación completada",
