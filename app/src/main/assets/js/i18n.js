  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        m_download: "Download",
        ab_title: "A–B REPEAT", ab_set: "SET", ab_clear: "CLEAR", ab_hint: "Tap the wave to seek · pinch to zoom · set A/B then drag them", ab_wave_na: "Waveform unavailable for streaming", ab_wave_load: "Decoding waveform…", ab_step: "Step",
    ...
    es: {
      ...
      strings: {
        ...
        ab_title: "REPETIR A–B", ab_set: "FIJAR", ab_clear: "LIMPIAR", ab_hint: "Toca la onda para ir a un punto · pellizca para zoom · fija A/B y arrástralos", ab_wave_na: "Onda no disponible en streaming", ab_wave_load: "Decodificando onda…", ab_step: "Paso",
