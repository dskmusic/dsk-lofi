  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        sh_token_save: "SAVE",
        sh_token_sub: "Get a free token at audd.io. Stored locally on this device only.",
    ...
    es: {
      ...
      strings: {
        ...
        sh_token_sub: "Consigue un token gratis en audd.io. Se guarda solo en este dispositivo.",
