  ...
  const LANGS = {
    ...
    en: {
      ...
      strings: {
        ...
        stm_title: "AI VOICE SEPARATION", stm_model: "MODEL", stm_model_default: "Default (auto-download)", stm_tier_fast: "Fastest", stm_tier_mid: "Medium", stm_tier_yours: "Yours / others", stm_installed: "Downloaded", stm_tier_fav: "Favorites", stm_fav: "Favorite", stm_delete: "Delete", stm_deleted: "Model deleted", stm_recommended: "Recommended", stm_time_ph: "s", stm_time_hint: "Your benchmark time (seconds)", stm_del_confirm: "Delete this model file?", stm_download: "Download", stm_dl_done: "Model downloaded", stm_dl_fail: "Download failed", stm_dl_busy: "A download is already running", stm_pick_model: "Download and pick a model first",
        ...
        ex_up: "Up", ex_move_up: "Move up", ex_move_down: "Move down", ex_empty: "Empty folder", ex_no_roots: "No folders yet — add one to browse.",
    ...
    es: {
      ...
      strings: {
        ...
        ex_up: "Subir", ex_move_up: "Subir", ex_move_down: "Bajar", ex_empty: "Carpeta vacía", ex_no_roots: "Aún no hay carpetas — añade una para explorar.",
